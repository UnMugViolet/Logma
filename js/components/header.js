            ...
            <nav class="container flex-container spacing-nav">
                ...
                <div class="vertical-align w-trois-quart nav-menu">
                    ...
                    <ul class="flex-container vertical-align spacing-icon-header">
                        <li class="nav-item">
                            <a href="https://www.instagram.com/logma_production/" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                                    class="vertical-align" viewBox="0 0 24 24">
                                    <path fill="#ffffff"
                        ...
                        <li class="nav-item">
                            <a href="https://www.youtube.com/@logma_production" target="_blank">
                        ...
                        <li class="nav-item">
                            <a href="https://www.linkedin.com/company/logma-agency/" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                                    class="vertical-align" viewBox="-2 -2 24 24">
                                    <g fill="#ffffff">
                                        <path
