...
<header class="header-content top-0 w-full">
    <nav class="container flex-container spacing-nav">
        <div class="logo-size">
            <a href="/">
                <img src="./ressources/img/logo-logma.webp" alt="Logo société Logma" aria-label="Retour à la page d'accueil">
            </a>
        </div>
        <div class="vertical-align w-trois-quart nav-menu w-full h-full">
            <ul class="flex-end w-full spacing-components-header">
                <li class="nav-item">
                    <a class="link-style-nav" href="./a-propos" aria-label="En savoir plus sur Logma">A propos</a>
                </li>
            ...
            <ul class="flex-container vertical-align spacing-icon-header">
                <li class="nav-item">
                    <a href="https://www.instagram.com/logma.production/" target="_blank" aria-label="Lien Instagram" rel="noopener">
                ...
                <li class="nav-item">
                    <a href="https://www.youtube.com/@logma_production" target="_blank" aria-label="Lien chaine Youtube" rel="noopener">
                ...
                <li class="nav-item">
                    <a href="https://www.linkedin.com/company/logma-agency/" target="_blank" aria-label="Lien du compte Linkedin" rel="noopener">
    ...
    ?>
                ...
                <li class="nav-item">
                    <a href="./access-admin-logma" rel="nofollow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" class="vertical-align" viewBox="0 0 24 24">
